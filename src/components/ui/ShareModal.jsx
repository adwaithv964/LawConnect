...
// If AppIcon is not in components/ui/AppIcon.jsx but components/AppIcon.jsx, I need to adjust.
// The previous file imported it from '../../../components/AppIcon'. So it is in src/components/AppIcon.jsx.
import { Copy, Check } from 'lucide-react';

const ShareModal = ({ isOpen, onClose, title, shareText, shareUrl }) => {
    ...
    // WhatsApp URL: https://wa.me/?text=encodedText
    // Telegram URL: https://t.me/share/url?url=encodedUrl&text=encodedText
    // Gmail URL: mailto:?subject=...&body=...
    ...
    const shareOptions = [
        ...
        },
        {
            ...
            action: () => window.open(`https://t.me/share/url?url=${encodedUrl}&text=${encodeURIComponent(`Check out this document: ${title}`)}`, '_blank')
        },
        {
            name: "Gmail",
            icon: (
            ...
            action: () => window.open(`mailto:?subject=${encodeURIComponent(`Shared Document: ${title}`)}&body=${encodedText}`, '_blank')
        }
    ];
